...
SETTING_DEFINITIONS: dict[str, dict] = {
    ...
    "POSTGRES_HOST": {
        "type": SettingType.STRING,
        "category": SettingCategory.LONG_TERM_STORAGE,
        "description": "PostgreSQL host for long-term storage",
        "default": "localhost",
    ...
    "CHECKPOINT_PG_HOST": {
        "type": SettingType.STRING,
        "category": SettingCategory.DATABASE,
        "description": "PostgreSQL host for checkpoint storage. Leave empty to use POSTGRES_HOST.",
        "default": "",
    ...
    "CHECKPOINT_PG_PORT": {
        "type": SettingType.NUMBER,
        "category": SettingCategory.DATABASE,
        "description": "PostgreSQL port for checkpoint storage",
        "default": 5432,
        "depends_on": {"key": "CHECKPOINT_BACKEND", "value": "postgres"},
    },
    "CHECKPOINT_PG_USER": {
        "type": SettingType.STRING,
        "category": SettingCategory.DATABASE,
        "description": "PostgreSQL username for checkpoint storage. Leave empty to use POSTGRES_USER.",
        "default": "",
        "depends_on": {"key": "CHECKPOINT_BACKEND", "value": "postgres"},
    },
    "CHECKPOINT_PG_PASSWORD": {
        "type": SettingType.STRING,
        "category": SettingCategory.DATABASE,
        "description": "PostgreSQL password for checkpoint storage. Leave empty to use POSTGRES_PASSWORD.",
        "default": "",
        "is_sensitive": True,
        "depends_on": {"key": "CHECKPOINT_BACKEND", "value": "postgres"},
    },
    "CHECKPOINT_PG_DB": {
        "type": SettingType.STRING,
        "category": SettingCategory.DATABASE,
        "description": "PostgreSQL database for checkpoint storage. Leave empty to use POSTGRES_DB.",
        "default": "",
        "depends_on": {"key": "CHECKPOINT_BACKEND", "value": "postgres"},
    },
    "CHECKPOINT_PG_POOL_MIN_SIZE": {
        "type": SettingType.NUMBER,
        "category": SettingCategory.DATABASE,
        "description": "Checkpoint PostgreSQL connection pool minimum size",
        "default": 2,
        "depends_on": {"key": "CHECKPOINT_BACKEND", "value": "postgres"},
    },
    "CHECKPOINT_PG_POOL_MAX_SIZE": {
        "type": SettingType.NUMBER,
        "category": SettingCategory.DATABASE,
        "description": "Checkpoint PostgreSQL connection pool maximum size",
        "default": 10,
        "depends_on": {"key": "CHECKPOINT_BACKEND", "value": "postgres"},
    },
    # ============================================

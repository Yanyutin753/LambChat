...
// 520KB：518KB + web_fetch 专属 Item（WebFetchItem 阅读面板/供应商徽章）与
// web_search/web_fetch 五语 locale 文案进入 eager 路径（#532），沿 2KB 阶梯
// 惯例累加抬档。
export const EAGER_JAVASCRIPT_BUDGET_BYTES = 520 * 1024;

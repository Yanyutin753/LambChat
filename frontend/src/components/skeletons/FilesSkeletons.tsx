        ...
        <div className="relative px-5 md:px-6 py-3 md:py-4">
          <div className="flex items-center justify-between gap-3 w-full">
            <div className="flex flex-wrap gap-2 items-center">
              ...
              <div className="skeleton-line h-8 w-24 rounded-lg hidden md:block" />
              <div className="skeleton-line h-8 w-20 rounded-lg" />
            </div>
            <div className="flex items-center gap-2 shrink-0">
              <div className="skeleton-line h-9 w-[160px] md:w-[200px] rounded-lg" />
              <div className="skeleton-line h-8 w-16 rounded-lg hidden md:block" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col pb-6 px-5 md:px-6 gap-3 md:gap-6">
          ...
          <div className="flex flex-col gap-2.5 md:gap-3">
            <div className="flex items-center justify-between gap-2 pt-4 md:pt-5">
              <SkeletonLine width="w-40" className="!h-[15px] !rounded-md" />
              <div className="skeleton-line h-[18px] w-10 rounded-md" />
            </div>
          ...
          <div className="flex flex-col gap-2.5 md:gap-3">
            <div className="flex items-center justify-between gap-2 pt-4 md:pt-5">
              <SkeletonLine width="w-32" className="!h-[15px] !rounded-md" />
              <div className="skeleton-line h-[18px] w-10 rounded-md" />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 items-start">
              {[0, 1].map((i) => (
                ...
                >
                  ...
                  <div className="px-2.5 py-2">
                    <SkeletonLine width="w-1/3" className="!h-[11px]" />
                  </div>
                </div>
              ))}
            </div>

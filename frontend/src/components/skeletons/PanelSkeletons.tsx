            ...
            <div key={i} className="panel-card flex flex-col p-4 sm:p-5">
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                  ...
                  <SkeletonLine
                    width="w-20"
                    className="!h-5 mt-2 !rounded-full"
                  />
                </div>
              </div>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                ...
                <SkeletonLine width="w-18" className="!h-5 !rounded-full" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {Array.from({ length: 9 }).map((_, i) => (
            <div key={i} className="panel-card overflow-hidden">
              <div className="skeleton-line h-12 w-full !rounded-none" />
              <div className="p-4">
                <div className="flex items-start gap-3">
                  <div className="skeleton-line size-10 rounded-xl shrink-0 -mt-6 ring-2" />
                  <div className="flex-1 min-w-0">
                    <SkeletonLine
                      width={i % 3 === 0 ? "w-3/4" : "w-1/2"}
                      className="!h-[16px]"
                    />
                    <SkeletonLine width="w-20" className="!h-3 mt-1" />
                  </div>
                </div>
                <div className="mt-2 space-y-1">
                  <SkeletonLine width="w-full" className="!h-3" />
                  <SkeletonLine width="w-4/5" className="!h-3" />
                </div>
                <div className="mt-3">
                  <SkeletonLine width="w-14" className="!h-5 !rounded-full" />
                </div>
          ...
          <div key={i} className="panel-card p-4">
            <div className="flex items-start justify-between">
              <div className="flex-1 min-w-0">
                ...
                <SkeletonLine width="w-3/4" className="!h-3 mt-2" />
          ...
          <div key={i} className="panel-card p-4">
            <div className="flex items-start justify-between">
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2">
                  <SkeletonLine width="w-3/5" className="!h-5 !rounded-md" />
                </div>
                <SkeletonLine width="w-24" className="!h-3 mt-2" />
              </div>
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
          {[0, 1, 2, 3].map((i) => (
            <div key={i} className="panel-card p-4">
              <div className="flex items-center gap-3">
                <div className="skeleton-line size-10 rounded-lg shrink-0" />
                <div>
                  <SkeletonLine width="w-12" className="!h-3" />
                  <SkeletonLine width="w-8" className="!h-6 mt-1" />
                </div>
              </div>
            </div>
          ))}
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="panel-card p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <SkeletonLine
                  width={i % 2 === 0 ? "w-32" : "w-28"}
                  className="!h-[16px]"
                />
                <SkeletonLine width="w-3/5" className="!h-3 mt-1" />
              </div>
              <SkeletonLine
                width="w-8"
                className="!h-5 !rounded-full shrink-0"
  ...
  return (
    <div className="flex h-full flex-col gap-4 animate-fade-in">
      ...
      <div
        ...
        style={{ borderColor: "var(--theme-border)" }}
      >
        <SkeletonLine width="w-20" className="!h-8 !rounded-md" />
        <SkeletonLine width="w-16" className="!h-8 !rounded-md" />
      </div>
      <div className="flex-1 overflow-y-auto min-h-0 space-y-3">
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="flex items-center gap-3.5 panel-card p-4">
            <div className="skeleton-line size-11 rounded-xl shrink-0" />
            <div className="flex-1 min-w-0">
              <SkeletonLine
                width={i % 2 === 0 ? "w-28" : "w-36"}
                className="!h-[14px]"
            ...
            <div className="skeleton-line w-10 h-5 rounded-full shrink-0" />
          </div>
        ))}
      </div>
    </div>
...
export function ModelPanelSkeleton() {
  return (
    <div className="flex h-full flex-col gap-4 animate-fade-in">
      ...
      >
        <SkeletonLine width="w-16" className="!h-8 !rounded-md" />
        <SkeletonLine width="w-28" className="!h-8 !rounded-md" />
      </div>
      <div className="flex-1 overflow-y-auto min-h-0 space-y-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="panel-card">
            <div className="flex items-center justify-between p-4">
              <div className="flex items-center gap-3 flex-1 min-w-0">
                <div className="skeleton-line size-5 rounded shrink-0" />
                <div className="skeleton-line size-6 rounded shrink-0" />
                <div className="flex-1 min-w-0">
                  <SkeletonLine
                    width={i % 2 === 0 ? "w-32" : "w-28"}
                    className="!h-[14px]"
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                <div className="skeleton-line w-10 h-5 rounded-full" />
                <div className="skeleton-line size-8 rounded-lg" />
                <div className="skeleton-line size-8 rounded-lg" />
              </div>
            </div>

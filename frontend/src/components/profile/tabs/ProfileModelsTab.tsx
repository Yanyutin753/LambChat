          ...
          {availableModels.map((model) => (
            ...
            >
              ...
              >
                ...
                {model.provider && (
                  <span className="inline-flex items-center px-1.5 py-0.5 rounded text-10 font-medium bg-stone-100 dark:bg-stone-700 text-stone-500 dark:text-stone-400 shrink-0">
                    {model.provider}
                  </span>
                )}
                {model.description && (

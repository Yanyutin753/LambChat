...
export function AuthPage({ onSuccess }: AuthPageProps) {
  ...
  return (
    <div className="min-h-screen overflow-y-auto overflow-x-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-stone-950 dark:via-stone-900 dark:to-stone-800">
      ...
      {/* 右上角按钮 */}
      <div className="fixed right-3 top-3 z-50 flex items-center gap-1.5 bg-white/50 backdrop-blur-sm rounded-lg p-1 dark:bg-stone-800/50 sm:right-4 sm:top-4 sm:gap-2 sm:bg-transparent sm:backdrop-blur-none dark:sm:bg-transparent">
        <LanguageToggle />
        <ThemeToggle />
      </div>
      ...
      {/* 主内容区域 - 使用 grid 实现真正的居中滚动 */}
      <div className="grid min-h-screen place-items-center px-4 py-16 sm:px-6 sm:py-8">
